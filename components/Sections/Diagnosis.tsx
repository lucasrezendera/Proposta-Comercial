...
export const Diagnosis: React.FC = () => {
  return (
    <section id={SectionId.DIAGNOSIS} className="py-16 relative bg-dark-950">
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          <div className="space-y-6 text-center md:text-left">
            <div className="space-y-3">
              ...
              <h2 className="font-display text-5xl md:text-6xl font-bold text-white leading-[1.1] uppercase">
