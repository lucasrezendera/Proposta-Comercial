...
export const Solution: React.FC = () => {
   return (
      <section id={SectionId.SOLUTION} className="py-16 bg-dark-900 relative overflow-hidden">
         <div className="container mx-auto max-w-6xl px-6 relative z-10">
            ...
            <div className="mb-8 text-center">
               <h2 className="font-display text-5xl md:text-6xl font-bold text-white mb-4 tracking-tighter UPPERCASE">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 grid-rows-2 gap-4 h-auto md:h-[650px]">
               ...
               {/* Card 1: Site (Main) */}
               <div className="md:col-span-8 md:row-span-1 group relative glass-card rounded-[2rem] overflow-hidden p-8 flex flex-col justify-between">
               ...
               {/* Card 2: App */}
               <div className="md:col-span-4 md:row-span-1 group relative glass-card rounded-[2rem] p-8 flex flex-col justify-between hover:bg-slate-900/50">
               ...
               {/* Card 3: Gestão */}
               <div className="md:col-span-4 md:row-span-1 group relative glass-card rounded-[2rem] p-8 flex flex-col justify-between border-dashed border-slate-800">
               ...
               {/* Card 4: Marca */}
               <div className="md:col-span-8 md:row-span-1 group relative glass-card rounded-[2rem] p-8 flex flex-col justify-between overflow-hidden">
